                 ...
                 <div class="faq-mobile-list">
                     ...
                     <div class="faq-mobile-item" data-category="payment">
                         ...
                         <div class="faq-mobile-answer">
                             ...
                             <ul>
                                 <li><strong>Paiement en ligne</strong> : Carte bancaire (Visa, Mastercard)</li>
                                 <li><strong>Paiement mobile</strong> : Nous acceptons les solutions de paiement mobile
                                     populaires au Maroc</li>
                                 <li><strong>Paiement à la livraison</strong> : Espèces ou carte bancaire via TPE mobile
                                 </li>
                                 <li><strong>Système de crédit</strong> : Pour nos clients abonnés, possibilité de
                                     paiement différé</li>
                             </ul>
